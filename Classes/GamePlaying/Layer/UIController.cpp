...
{
	GameResult::showResultWidget( isWin );
	
// 	m_GameResoult = GameResult::create();
// 	if ( m_GameResoult )
// 	{
// 		m_GameResoult->showResultWidget( isWin );
// 		Director::getInstance()->getRunningScene()->addChild(m_GameResoult,1000);
// 	}
}
